...
dt = 0.00001 # timestep # the time step can be decreased to decrease the approximation
step = 1 # loop counter
...
while step <= 12000:
    ...
    step = step + 1
    scene.center = Planet1.pos # changes the refrence frame with the moving planet
    if step%1000 == 0:   #by changing this value, the angle swept out between each measurement can be decreased, this also decreases error
