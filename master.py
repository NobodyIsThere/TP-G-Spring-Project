...
def create_planet(initial_distance,m):
    ...
    planet = sphere(pos=planet_pos,radius=1,color=color.blue, mass=m, velocity = planet_v)
...
Star = sphere(pos=vector(0,0,0),radius=3,color=color.yellow, velocity=vector(0,0,0), mass=M)
planets.append(Star)
